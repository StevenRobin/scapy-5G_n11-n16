...
def update_global_vars(i, ip_num=2000, port_num=20000):
    ...
    base = {
        ...
        "sport2": 5002,
        "sport3": 5003
    }    # 递增所有变量 - IP变量按ip_num循环，step=1
    sip1 = inc_ip(base["sip1"], i % ip_num)  # 按ip_num循环，step=1
    dip1 = inc_ip(base["dip1"], i % ip_num)  # 按ip_num循环，step=1
    auth1 = dip1
    auth2 = sip1
    ...
    upfIP1 = inc_ip(base["upfIP1"], i % ip_num)  # 按ip_num循环，step=1
    upTEID1 = inc_hex(base["upTEID1"], i)
    gnbIP1 = inc_ip(base["gnbIP1"], i % ip_num)  # 按ip_num循环，step=1
